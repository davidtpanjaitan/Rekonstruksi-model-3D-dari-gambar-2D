...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--mode', type=str, default='color', help='inout || color')
        ...
        g_test.add_argument('--test_folder_path', type=str, default='test_images', help='the folder of test image')
        ...
        g_model.add_argument('--netG', type=str, default='fanimp', help='piximp | fanimp')
        ...
        # path
        parser.add_argument('--checkpoints_path', type=str, default='./reconstruction/checkpoints', help='path to save checkpoints')
        parser.add_argument('--load_netG_checkpoint_path', type=str, default='./reconstruction/checkpoints/net_G', help='path to save checkpoints')
        parser.add_argument('--load_netC_checkpoint_path', type=str, default='./reconstruction/checkpoints/net_C', help='path to save checkpoints')
        parser.add_argument('--results_path', type=str, default='./eval_results', help='path to save results ply')
